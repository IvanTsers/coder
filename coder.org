...
#+end_src
#+begin_export latex
The program \texttt{coder} has two options:
...
#+end_src
#+begin_export latex
We append an undefined residue if any of the nucleotide codes in the
triplet is invalid.
#+end_export
...
is, non-\texttt{X}. We treat the translation termination \texttt{*} as
a defined residue.
#+end_export
...
#+end_src
#+begin_export latex
We print the result sequence to the \texttt{stdout}.
#+end_export
